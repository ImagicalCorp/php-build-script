...
wp="install_log/log_wget_php"
	...
	curl -O --insecure http://imagicalcorp.github.io/ImagicalMine/service-download/ImagicalMine.phar >>./$w 2>>./$w
	...
	wget --no-check-certificate http://imagicalcorp.github.io/ImagicalMine/service-download/ImagicalMine.phar >>./$w 2>>./$w
